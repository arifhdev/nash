<div x-data="{ open: false }" class="relative" @mouseleave="open = false">
    {{-- Trigger Icon dengan Padding Tambahan --}}
    <div class="pb-2">
        <button @mouseenter="open = true" 
                @click="open = !open"
                class="flex items-center focus:outline-none transition-transform duration-200 transform hover:scale-105">
    ...
    <div x-show="open" 
        ...
        @auth
            ...
            {{-- Links --}}
            <div class="py-1">
                <a href="{{ route('my-learning') }}" wire:navigate class="group flex items-center px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <a href="{{ route('my-courses') }}" wire:navigate class="group flex items-center px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                ...
                <a href="{{ route('profile.settings') }}" wire:navigate class="group flex items-center px-5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
        ...
        @else
            ...
            <div class="p-5 flex flex-col items-center justify-center text-center">
                ...
                {{-- Tombol Login --}}
                <a href="{{ route('login') }}" wire:navigate class="w-full flex justify-center items-center px-4 py-2 bg-[#ED1C24] text-white text-sm font-bold rounded-lg shadow hover:bg-red-700 hover:shadow-lg transition-all duration-200">
                    Masuk Akun
                </a>
            </div>
        @endauth
