...
class="flex h-screen bg-white font-sans overflow-hidden">
    ...
    <div x-data="{
            ...
            videoProgress: 0, 
            progressTimer: null, 
            currentTimeDisplay: '00:00', // State format waktu berjalan
            durationDisplay: '00:00',    // State format total waktu
            ...
            initYoutube() {
                ...
                window.onYouTubeIframeAPIReady = () => {
                    this.player = new YT.Player('youtube-player', {
                        events: {
                            'onReady': () => {
                                // Ambil durasi total saat video siap
                                setTimeout(() => {
                            ...
                            'onStateChange': (event) => {
                                ...
                                if (this.isPlaying) {
                                    ...
                                    // Set durasi lagi buat jaga-jaga
                                    this.durationDisplay = this.formatTime(this.player.getDuration());
                                } else {
                                ...
                                if (event.data === 0) {
                                    ...
                                    this.currentTimeDisplay = this.durationDisplay; // Mentok di akhir
                ...
                this.progressTimer = setInterval(() => {
                    if (this.player && typeof this.player.getCurrentTime === 'function') {
                        ...
                        if(duration > 0) {
                            ...
                            this.currentTimeDisplay = this.formatTime(currentTime); // Update text menit detik
                        }
                    }
                }, 500); 
            },
            ...
            backward10s() {
                if (this.player && typeof this.player.getCurrentTime === 'function') {
                    ...
                    this.currentTimeDisplay = this.formatTime(newTime); // Langsung update text-nya juga
                }
            },
            toggleFullscreen() {
        ...
        {{-- KUMPULAN KONTROL KIRI BAWAH (Tombol 10s & Waktu) --}}
        ...
        <button @click="toggleFullscreen()"
            ...
            <svg x-show="isFullscreen" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 drop-shadow-md" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v4h4m-4-4l5 5M20 8V4h-4m4 4l-5-5M4 8V4h4m-4 4l5-5M20 16v4h-4m4-4l-5 5" />
            </svg>
        </button>

        {{-- READ-ONLY PROGRESS BAR DI BAWAH VIDEO --}}
        <div class="absolute bottom-0 left-0 right-0 z-20 h-1.5 bg-gray-600">
            <div class="h-full bg-red-600 transition-all duration-500 ease-linear" :style="`width: ${videoProgress}%`"></div>
                        ...
                        @else
                            <div class="relative w-full bg-black rounded-2xl shadow-2xl overflow-hidden" 
