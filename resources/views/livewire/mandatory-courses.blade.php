                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 min-h-[700px]">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-6 border-b border-gray-100 gap-4">
                        ...
                        <div class="relative w-full md:w-72">
                            ...
                            {{-- PERBAIKAN DI SINI: Menggunakan SVG manual alih-alih x-loading-spinner --}}
                    ...
                    <div class="flex flex-col gap-5">
                        @forelse($courses as $course)
                            @php
                                // Cek apakah user sudah mengambil course ini
                                $enrollment = $course->users->first();
                                $progress = $enrollment ? $enrollment->pivot->progress_percent : 0;
                            @endphp

                            {{-- Course Item Card - Horizontal Layout --}}
                            <div class="group flex flex-col sm:flex-row bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-red-200 hover:shadow-lg hover:shadow-red-500/5 transition-all duration-300">
